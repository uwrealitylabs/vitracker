...
#define IT6263_LVDS_SLAVE_ADDR 0x66
...
BOOL EnableVideoOutput(BYTE level,BYTE inputColorMode,BYTE outputColorMode,BYTE bHDMI);
BOOL SetupVideoInputSignal(BYTE inputSignalType);

BOOL EnableAudioOutput(unsigned long cVideoPixelClock,BYTE bAudioSampleFreq,BYTE ChannelNumber,BYTE bAudSWL,BYTE bSPDIF);
void DisableIT626X();
