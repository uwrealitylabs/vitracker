...
# Version: 2022.M.15
# Date: 2022-01-25 14:48

# Copyright (C) 2017 - 2022 Efinix Inc. All rights reserved.

# Device: T120F324
# Project: mipi_pi_cam_debayer_top
...
create_clock -period 36.88 i_sysclk
create_clock -period 12.50 axi_clk

set_clock_groups -exclusive -group {tx_slowclk} -group {mipi_pclk}
set_clock_groups -exclusive -group {tx_slowclk} -group {axi_clk}
set_clock_groups -exclusive -group {axi_clk} -group {mipi_pclk}
set_clock_groups -exclusive -group {i_sysclk} -group {mipi_pclk}

# GPIO Constraints
####################
# set_input_delay -clock <CLOCK> -max <MAX CALCULATION> [get_ports {clk_20m}]
# set_input_delay -clock <CLOCK> -min <MIN CALCULATION> [get_ports {clk_20m}]
