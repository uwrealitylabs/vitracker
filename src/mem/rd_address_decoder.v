...
//	.i_rclk 	(axi_clk),  
//	.i_re 		(rstn),  
//	.o_rdata 	({r_axi_de, axi_valid, axi_hsync, r_axi_vsync})
//);
...
begin
	...
	begin		
		...
		if (!r_in_de_0L_1P && r_in_de_0L_2P)
		begin
			if (r_axi_ycnt == r_y_start + r_y_win)
				r_axi_ycnt	<= r_y_start;
			else
...
begin
	...
	begin		
		...
		begin
			//if (r_y_cnt_2L_1P == r_y_start + r_y_win)
			//	r_y_cnt_2L_1P	<= r_y_start;
			//else
