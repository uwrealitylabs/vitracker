...
module edb_top (
    ...
    output bscan_TDO,
    input  VIO_0_clk,
    input  [5:0] VIO_0_MIPI_TYPE,
    input  VIO_0_MIPI_HSYNC,
    input  VIO_0_MIPI_VSYNC,
    input  [3:0] VIO_0_MIPI_SCNT,
    input  [62:0] VIO_0_MIPI_DATA,
    input  VIO_0_MIPI_VALID,
    input  [1:0] VIO_0_MIPI_VC,
    input  [17:0] VIO_0_MIPI_ERROR,
    input  [2:0] VIO_0_I2C_STATE,
    input  [9:0] VIO_0_I2C_REG_DOUT,
    output VIO_0_PROBE_TRIGGER,
    output [2:0] VIO_0_RED_GAIN,
    output [2:0] VIO_0_GREEN_GAIN,
    output [2:0] VIO_0_BLUE_GAIN,
    output [10:0] VIO_0_X_WIN,
    output [10:0] VIO_0_X_START,
    output [10:0] VIO_0_Y_WIN,
    output [10:0] VIO_0_Y_START,
    output [10:0] VIO_0_X_POINTER,
    output [10:0] VIO_0_Y_POINTER,
    output [9:0] VIO_0_RED_BACK,
    output [9:0] VIO_0_GREEN_BACK,
    output [9:0] VIO_0_BLUE_BACK,
    output VIO_0_MIPI_CLEAR,
    output VIO_0_I2C_REG_WE,
    output [7:0] VIO_0_I2C_REG_DIN,
    output [9:0] VIO_0_I2C_REG_ADDR,
    output VIO_0_I2C_REG_RECONFIG
);
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 10 ),
        .NUM_PROBE_OUT          ( 18 ),
        .UUID           ( 128'h810138b978bf44e98ac705b1ad5bbc3d ),
        .PROBE_IN0_WIDTH        ( 6 ),
        .PROBE_IN1_WIDTH        ( 1 ),
        .PROBE_IN2_WIDTH        ( 1 ),
        .PROBE_IN3_WIDTH        ( 4 ),
        ...
        .PROBE_OUT8_WIDTH       ( 11 ),
        .PROBE_OUT9_WIDTH       ( 11 ),
        .PROBE_OUT10_WIDTH      ( 10 ),
        .PROBE_OUT11_WIDTH      ( 10 ),
        .PROBE_OUT12_WIDTH      ( 10 ),
        .PROBE_OUT13_WIDTH      ( 1 ),
        .PROBE_OUT14_WIDTH      ( 1 ),
        .PROBE_OUT15_WIDTH      ( 8 ),
        .PROBE_OUT16_WIDTH      ( 10 ),
        .PROBE_OUT17_WIDTH      ( 1 ),
        .PROBE_OUT0_INIT_VAL    ( 'h0 ),
        .PROBE_OUT1_INIT_VAL    ( 'h7 ),
        .PROBE_OUT2_INIT_VAL    ( 'h4 ),
        .PROBE_OUT3_INIT_VAL    ( 'h5 ),
        .PROBE_OUT4_INIT_VAL    ( 'h1df ),
        .PROBE_OUT5_INIT_VAL    ( 'h0 ),
        .PROBE_OUT6_INIT_VAL    ( 'h437 ),
        ...
        .PROBE_OUT13_INIT_VAL   ( 'h0 ),
        .PROBE_OUT14_INIT_VAL   ( 'h0 ),
        .PROBE_OUT15_INIT_VAL   ( 'h0 ),
        .PROBE_OUT16_INIT_VAL   ( 'h0 ),
        .PROBE_OUT17_INIT_VAL   ( 'h0 )
    ) VIO_0 (
        ...
        .clk                ( VIO_0_clk ),
        .probe_in0          ( VIO_0_MIPI_TYPE ),
        .probe_in1          ( VIO_0_MIPI_HSYNC ),
        .probe_in2          ( VIO_0_MIPI_VSYNC ),
        .probe_in3          ( VIO_0_MIPI_SCNT ),
        .probe_in4          ( VIO_0_MIPI_DATA ),
        .probe_in5          ( VIO_0_MIPI_VALID ),
        .probe_in6          ( VIO_0_MIPI_VC ),
        .probe_in7          ( VIO_0_MIPI_ERROR ),
        .probe_in8          ( VIO_0_I2C_STATE ),
        .probe_in9          ( VIO_0_I2C_REG_DOUT ),
        .probe_in10         ( 1'b0 ),
        .probe_in11         ( 1'b0 ),
        .probe_in12         ( 1'b0 ),
        .probe_in13         ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( VIO_0_PROBE_TRIGGER ),
        .probe_out1         ( VIO_0_RED_GAIN ),
        .probe_out2         ( VIO_0_GREEN_GAIN ),
        .probe_out3         ( VIO_0_BLUE_GAIN ),
        .probe_out4         ( VIO_0_X_WIN ),
        .probe_out5         ( VIO_0_X_START ),
        .probe_out6         ( VIO_0_Y_WIN ),
        .probe_out7         ( VIO_0_Y_START ),
        .probe_out8         ( VIO_0_X_POINTER ),
        .probe_out9         ( VIO_0_Y_POINTER ),
        .probe_out10            ( VIO_0_RED_BACK ),
        .probe_out11            ( VIO_0_GREEN_BACK ),
        .probe_out12            ( VIO_0_BLUE_BACK ),
        .probe_out13            ( VIO_0_MIPI_CLEAR ),
        .probe_out14            ( VIO_0_I2C_REG_WE ),
        .probe_out15            ( VIO_0_I2C_REG_DIN ),
        .probe_out16            ( VIO_0_I2C_REG_ADDR ),
        .probe_out17            ( VIO_0_I2C_REG_RECONFIG ),
        .probe_out18            (  ),
        .probe_out19            (  ),
        .probe_out20            (  ),
        .probe_out21            (  ),
